from .losses import (TripletLossNoHardMining, ProtoRegularization, ProtoCFLoss,
                     ...
                     PTFixPNLoss, PTFixPNLossV2, IncrementalPTFixPNLoss, IncrementalPTFixPNLossV2, IncrementalPTFixPNLossV3, SimilarBufferCenterLoss, CosineSimilarBufferCenterLoss,
...
__all__ = [
    ...
    'IncrementalPTFixPNLossV2',
    'IncrementalPTFixPNLossV3',
